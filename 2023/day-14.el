...
(defun tilt-platform (platform dir)
  ;; NOTE: `dir' is a 2-dimesional axis-aligned unit vector that specifies the
  ;; direction in which the rocks roll.
  (prog1 platform
...
(expect (solve-14-1 *test-14*) 136)
(expect (solve-14-1 *input-14*) 110407)
...
(expect (solve-14-2 *test-14*) 64)
(expect (solve-14-2 *input-14*) 87273 :gc 4000000000)
